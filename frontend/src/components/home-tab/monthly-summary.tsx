...
import { analyticsService, type MonthlyExpenses } from '@/services/api';
...
const MonthlySummary = () => {
  ...
  useEffect(() => {
    ...
    if (monthlyData.length > 0) {
      api.scrollTo(monthlyData.length - 1);
    }
  }, [api, monthlyData.length]);
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      ...
                      <SummaryCard
                        ...
                        amountColor={transactionUtils.getBalanceColor(monthData.balance)}
                      />
                    </div>
